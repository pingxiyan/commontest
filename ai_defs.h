...
修改记录:
日  期        版本        修改人        走读人    修改内容
2012/03/20    1.0         罗成                    创建
2013/08/01    2.0         周勃                    修改
******************************************************************************/
...
typedef double          d64;
    ...
    typedef unsigned int      ptrv;    //表征指针值的数据类型，其长度与系统的位长有关

    #define INLINE inline
    #define FAST_CALL 
    #define EXPORT 
    #define RESTRICT restrict
#elif defined (ARCH_X64_LINUX) || defined (ARCH_X86_LINUX)      //64位和32位Linux系统
    typedef unsigned long long x64;
    typedef long long           s64;
    typedef unsigned long long u64;
    typedef int                l32;
    typedef unsigned int       u32;
    typedef unsigned long      ptrv;    //表征指针值的数据类型，其长度与系统的位长有关

    #define INLINE inline
    #define FAST_CALL __attribute__((fastcall))
    #define EXPORT 
    #define RESTRICT 
#elif defined(ARCH_ATOM_LINUX) || defined(ARCH_ARM_LINUX)  || defined(ARCH_POWERPC_LINUX)//ARM平台 Linux系统
    typedef unsigned long long x64;
    typedef long long           s64;
    typedef unsigned long long u64;
    typedef long               l32;
    ...
    #define EXPORT
    #define RESTRICT
#elif defined ARCH_X64_WIN64       //64位windows系统
    typedef unsigned __int64   x64;
    typedef __int64               s64;
    typedef unsigned __int64   u64;
    typedef int                l32;
    typedef unsigned int       u32;
    typedef unsigned __int64   ptrv;    //表征指针值的数据类型，其长度与系统的位长有关
...
#define MIN_VERSION_LEN 256    //版本信息（版本字符串）的最小长度
